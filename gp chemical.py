...
data = pd.read_csv('ENTROPY_processed.csv')

# separate data into train and test
X_train, X_test, y_train, y_test = train_test_split(data.drop(columns=['names', 'Formula ','entropy','SMILES',	'No.']), # X: Remove the target label column and ID (not needed)
